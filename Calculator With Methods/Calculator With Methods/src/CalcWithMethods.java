	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1: { //Add two numbers together
				System.out.println("Answer: " + add(getOperand("Enter first number"),getOperand("Enter Second Number")));
				break;			
			}
			case 2: { //Subtract two numbers
				System.out.println("Answer: " + subtract(getOperand("Enter first number"),getOperand("Enter Second Number")));
				break;	
			}
			case 3: { //multiply two numbers
				System.out.println("Answer: " + multiply(getOperand("Enter first number"),getOperand("Enter Second Number")));
				break;	
			}
			case 4: { //divide two numbers
				System.out.println("Answer: " + divide(getOperand("Enter first number"),getOperand("Enter Second Number")));
				break;	
			}
			case 5: {//generate random number
				System.out.println("Answer: " + random(getOperand("Enter first number"),getOperand("Enter Second Number")));
			}
